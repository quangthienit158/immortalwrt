...
m = Map("modem", translate("Custom Modem Support"), translate("Custom Modem Ports"))
...
a1 = e:option(Value, "vid", translate("Swiched Vendor ID:")); 
a1.optional=false;

b1 = e:option(Value, "pid", translate("Swiched Product ID:")); 
b1.optional=false; 
