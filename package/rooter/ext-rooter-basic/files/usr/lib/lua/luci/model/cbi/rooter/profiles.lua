...
alive:value("1", translate("Enable write to syslog when disconnected"))
alive:value("2", translate("If the 5G module is disconnected, the router will automatically restart"))
alive:value("3", translate("Enable automatic redial when the 5G module is offline"))
alive:value("4", translate("If the 5G module is disconnected, then re-power on the module, which requires routing GPIO support, otherwise it will use other methods to reconnect"))
alive.default=0
...
calive:value("1", translate("Enable write to syslog when disconnected"))
calive:value("2", translate("If the 5G module is disconnected, the router will automatically restart"))
calive:value("3", translate("Enable automatic redial when the 5G module is offline"))
calive:value("4", translate("If the 5G module is disconnected, then re-power on the module, which requires routing GPIO support, otherwise it will use other methods to reconnect"))
calive.default=0
